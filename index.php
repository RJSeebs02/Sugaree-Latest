    ...
    <body>
        <header>
            ...
            <div class="icons">
                ...
                <a href="module-profile/profile.php" id="loginLink" class="fas fa-user"></a> 
                ...
                <div class="swiper-wrapper wrapper">
                    ...
                    <div class="swiper-slide slide">
                        <div class="content">
                            ...
                            <a href="module-menu/menu.php" class="btn">Order Now</a>
                        </div>
                        <div class="image">
        ...
        <section class="news" id="news">
            <div class="container">
                <div class="sec-title text-center mb-5">
                    <h3 class="sub-heading">Announcements</h2>
        ...
        <h3 class="heading"> Popular Dishes </h3>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <a href="module-menu/menu.php?category=<?php echo urlencode($dish['dish_category']); ?>" class="btn">Go to Menu</a>
                </div>
                <?php endforeach; ?>
            </div>
        </section>
