...
VALUES 
(NULL, "Meatballs with Pesto", "img/menu/Appetizers/Meatballs with Pesto.png", "Appetizers", "Yes", "Lorem ipsum dolor sit amet"),
(NULL, "Donut Tiramisu", "img/menu/Donuts/Donut Tiramisu.png", "Donuts", "Yes", "Lorem ipsum dolor sit amet"), 
(NULL, "Glazed Watermelon Donut", "img/menu/Donuts/Glazed Watermelon Donut.png", "Donuts", "Yes", "Lorem ipsum dolor sit amet"), 
(NULL, "Lemon Merengue Donut", "img/menu/Donuts/Lemon Merengue Donut.png", "Donuts", "Yes", "Lorem ipsum dolor sit amet"), 
(NULL, "Eggplant Parm with Mozzarella", "img/menu/Sandwiches/Eggplant Parm with Mozzarella.png", "Sandwiches", "Yes", "Lorem ipsum dolor sit amet"), 
(NULL, "Inasal Cheese Steak", "img/menu/Sandwiches/Inasal Cheese Steak.png", "Sandwiches", "Yes", "Lorem ipsum dolor sit amet"), 
(NULL, "Meatball Parm with Mozzarella", "img/menu/Sandwiches/Meatball Parm with Mozzarella.png", "Sandwiches", "Yes", "Lorem ipsum dolor sit amet"),
(NULL, "Philly Cheese Steak", "img/menu/Sandwiches/Philly Cheese Steak.png", "Sandwiches", "Yes", "Lorem ipsum dolor sit amet"),
(NULL, "Salisbury Italian Roast Pork with Spinach and Provolone Cheese", "img/menu/Sandwiches/Salisbury Italian Roast Pork with Spinach and Provolone Cheese.png", "Sandwiches", "Yes", "Lorem ipsum dolor sit amet");
;
