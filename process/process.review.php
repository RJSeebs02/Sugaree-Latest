...
function create_review(){
    ...
    $user_rating = $_POST['Rating'];
        ...
        if($result){
            header("location: ../module-profile/profile.php?subpage=review");
    }
}
...
function delete_admin(){
    if (isset($_POST['adm_username'])) {
        ...
        if ($result) {
            header("location: ../module-review/index.php?page=admins");
        } 
    }
}
...
function update_user_image(){
    ...
    if($result){
        header("location: ../module-profile/profile.php");
    }
}
